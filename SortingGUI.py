...
class Toplevel:
    ...
    def __init__(self, top=None):
        ...
        #Lower canvas where the animation happens
        ...
        #Top canvas where the controls are
        ...
        #Sliding scale for the number of elements
        ...
        #Sliding scale for the sorting speed
